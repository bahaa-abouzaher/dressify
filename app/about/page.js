...
function page() {
  return (
    <div className="flex flex-col gap-10 max-w-7xl max-md2:px-4 text-(--main-text)">
      <div className="flex flex-col gap-3 border-b border-gray-200 pb-6 ">
        <h3 className="text-xl text-(--gray-text) font-semibold ">About Dressify</h3>
       ...
       <div className="grid md2:grid-cols-2 gap-6 grid-cols-1">
          ...
          <div className="flex flex-col gap-3">
            <h1 className="text-xl text-(--gray-text) font-medium">
       ...
       <div className="grid md2:grid-cols-2 gap-10 grid-cols-1">
          <div className="flex flex-col gap-3 order-2 md2:order-1 max-md2:px-4">
            <h1 className="text-2xl text-(--gray-text) font-medium">
